...
export default function LandingView() {
  ...
  return (
    <div className="bg-white min-h-screen text-slate-800 font-sans selection:bg-[#FFBA00]/30 selection:text-[#0044B5]">
      ...
      <main>
        ...
        <section className="relative min-h-[80vh] md:h-[90vh] bg-[#0044B5] overflow-hidden flex items-center">
          ...
          <div className="container mx-auto px-6 md:px-20 relative z-20">
            <div className="max-w-3xl">
              <div className="mb-8 overflow-hidden pb-4">
                <img 
                  src={somosLogo} 
                  alt="Somos Comunidad" 
                  className="h-40 md:h-64 object-contain brightness-0 invert animate-slide-up" 
                />
              </div>
              ...
              <p className="text-white text-lg md:text-xl font-medium leading-relaxed mb-12 max-w-xl animate-fade-in" style={{ animationDelay: '0.3s' }}>
                Movilizamos la generosidad y el esfuerzo en nuestra comunidad. 
                Desde la recuperación de espacios hasta brindar apoyo a quien más lo necesita, cada acción cuenta.
              </p>
        ...
        <section className="w-full">
          <div className="flex flex-col md:flex-row w-full">
            ...
            <div className="w-full md:w-1/2 bg-white p-10 md:p-16 lg:p-24 text-slate-700 relative overflow-hidden border-r border-[#F4F6FA]">
              ...
              <div className="relative z-10 max-w-lg md:ml-auto">
                <h3 className="font-antonio text-4xl md:text-5xl uppercase tracking-wide mb-6 leading-tight text-[#0044B5]">
                  ¿QUÉ ACTIVIDADES <br/>PUEDES REGISTRAR?
                </h3>
                <p className="text-slate-600 mb-8 text-lg font-medium leading-relaxed">
                  Cualquier acción que beneficie directamente a tu comunidad, como por ejemplo:
                </p>
            ...
            <div className="w-full md:w-1/2 bg-[#A50034] p-10 md:p-16 lg:p-24 text-white relative overflow-hidden">
              {/* Curva sutil estilo corporativo */}
              ...
              <div className="relative z-10 max-w-lg md:mr-auto">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                <div key={idx} className="card-brand p-8 group hover:-translate-y-2 transition-all">
      ...
      <footer className="bg-[#002D7A] text-white py-16 px-6 border-t border-[#FFBA00]/30">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 items-center text-center md:text-left">
          {/* Logo United Way */}
          <div className="flex flex-col items-center md:items-start gap-4">
            <img src={uwchLogo} alt="United Way" className="h-16 w-auto brightness-0 invert object-contain" />

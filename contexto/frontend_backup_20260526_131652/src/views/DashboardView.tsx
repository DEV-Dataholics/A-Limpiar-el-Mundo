            ...
            <div className="p-8">
              {loadingEvents ? (
                ...
                <div className="space-y-10">
                  {/* Causas Oficiales */}
                  {userEvents.filter(e => e.activity_id != 9).length > 0 && (
                    <div>
                      <h3 className="font-antonio text-xl text-[#002D7A] uppercase mb-4 flex items-center gap-2">
                        <span className="w-8 h-px bg-[#FFBA00]"></span>
                        Causas Oficiales
                      </h3>
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                        {userEvents.filter(e => e.activity_id != 9).map((event) => (
                          <div key={event.id} className="card-brand overflow-hidden flex flex-col">
                            {/* Imagen / placeholder */}
                            ...
                            <div className="h-36 bg-[#EEF2FB] relative">
                              {event.evidence_image_url ? (
                                <img
                                  ...
                                  alt={event.custom_activity_name}
                                  className="w-full h-full object-cover"
                                />
                              ) : (
                                <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-[#EEF2FB] to-[#D8E2F0] overflow-hidden group">
